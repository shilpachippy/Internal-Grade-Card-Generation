           ...
           //*****************checking staff_reg is already registrered**************
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        string sql = "insert into [tbl_faculty] (dept_id,faculty_name,gender,dob,address,phone,email,usertype_id,faculty_type_id,username,passwords,active) values('" + ddl_dept.SelectedItem.Value + "','" + txt_name.Text + "','" + rbl_gender.SelectedItem.Text + "','" + txt_dob.Text + "' ,'" + txt_address.Text + "','" + txt_phone.Text + "','" + txt_email.Text + "','" + ddl_user.SelectedItem.Value + "','" + ddl_designation.SelectedItem.Value + "','" + txt_username.Text + "','" + txt_confirm_password + "',1)";
